...
{
    ParserTableViewController *parserTableViewController = [[ParserTableViewController alloc] init];
    
    AppDelegate *appDelegate = [UIApplication sharedApplication].delegate;
    parserTableViewController.managedObjectContext = appDelegate.managedObjectContext;
    
    return parserTableViewController.managedObjectContext;
}
